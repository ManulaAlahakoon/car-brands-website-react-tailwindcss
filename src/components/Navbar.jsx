...
const Navbar = () => {
    ...
    return ( 
        <div className="fixed w-full z-10">
            <div>
                <div className="flex flex-row justify-between p-5 lg:px-32 bg-gradient-to-r from-blue-100 via-blue-300 to-blue-500">
                    <div className="flex flex-row items-center cursor-pointer gap-2">
                        <span >
                            <IoCarSportSharp className="size-10" />
                        </span>
                        <h1 className="text-[24px]">Dream Cars</h1>
                    </div>
                ...
                <div className={`${menu ? "translate-x-0":"-translate-x-full"} md:hidden flex flex-col gap-8 bg-gradient-to-r from-cyan-500 to-blue-500  text-white text-center text-[24px] absolute top-20 py-16 w-full h-fit transition duration-500 `}>
